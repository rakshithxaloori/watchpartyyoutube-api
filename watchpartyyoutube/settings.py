"""
Django settings for watchpartyyoutube project.
...
ROOT_URLCONF = "watchpartyyoutube.urls"
...
WSGI_APPLICATION = "watchpartyyoutube.wsgi.application"
...
AWS_STORAGE_BUCKET_NAME = AWS_CDN_BUCKET_NAME
...
################################################################################
CSRF_TRUSTED_ORIGINS = ["https://*.watchpartyyoutube.com"]
...
################################################################################
# CORS
CORS_ALLOWED_ORIGIN_REGEXES = [r"^https://\w+\.watchpartyyoutube\.com$"]
